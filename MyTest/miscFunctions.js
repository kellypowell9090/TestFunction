...
module.exports = {
    ...
    getQbo: function (QuickBooks, args) {
        return new QuickBooks(args.consumerKey, args.consumerSecret, 
            args.accesstToken, false, /* no token secret for oAuth 2.0 */
            args.companyid,
            args.useSandbox,   QBO_DEBUG, 
            OAUTH_MINOR_VERSION, OAUTH_MAJOR_VERSION, args.refreshToken );
    }
